...
//		TaskDTO testTaskDto = new TaskDTO("Laundry", true);
//
//		// Rules
...
//		TaskDTO testTaskDto = new TaskDTO("groceries", false);
//
//		// Rules
//		Mockito.when(this.mapper.map(exampleTask, TaskDTO.class)).thenReturn(testTaskDto);
...
//
//		TaskDTO testTaskDTO1 = new TaskDTO("cooking", false);
//		TaskDTO testTaskDTO2 = new TaskDTO("dishes", true);
